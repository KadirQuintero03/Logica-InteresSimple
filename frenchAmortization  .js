...
const amortizacionFrancesa = (capital,tsa,cuotas,typeQuotas,typeInterest)=>{
    ...
    tsa = parseFloat(tsa)
    console.log(tsa)
    let cuotaTotal = (capital * tsa * Math.pow(1+tsa,cuotas))/(Math.pow(1+tsa,cuotas)-1)
...
const tabla = amortizacionFrancesa(capitalPrestamo,tasaInteres,cantidadCuotas,typeQuotas,typeTaseInterest)
